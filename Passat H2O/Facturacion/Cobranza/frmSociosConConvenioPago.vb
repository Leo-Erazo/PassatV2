Public Class frmSociosConConvenioPago

    Private Sub frmSociosConConvenioPago_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Using conn As New SqlClient.SqlConnection(instancia.pCadena_conexion)
                conn.Open()
                Using comm As New SqlClient.SqlCommand("Select Socio_ID, Propietario, Inquilino, Direccion_fisica From socios SO WHERE Convenio = 1", conn)
