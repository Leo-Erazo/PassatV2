...
Public Class CryFacturas_individuales
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryFacturas_individuales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryFacturas_individuales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryFacturas_individuales = New CryFacturas_individuales
        rpt.Site = Me.Site
        Return rpt
    End Function
