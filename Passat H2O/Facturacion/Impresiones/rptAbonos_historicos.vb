...
Public Class rptAbonos_historicos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAbonos_historicos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAbonos_historicos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAbonos_historicos = New rptAbonos_historicos
        rpt.Site = Me.Site
        Return rpt
    End Function
