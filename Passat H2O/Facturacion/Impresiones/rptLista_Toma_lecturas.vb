...
Public Class rptLista_Toma_lecturas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLista_Toma_lecturas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLista_Toma_lecturas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLista_Toma_lecturas = New rptLista_Toma_lecturas
        rpt.Site = Me.Site
        Return rpt
    End Function
