...
Public Class rptListado_Cobros_Del_Periodo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListado_Cobros_Del_Periodo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListado_Cobros_Del_Periodo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListado_Cobros_Del_Periodo = New rptListado_Cobros_Del_Periodo
        rpt.Site = Me.Site
        Return rpt
    End Function
